...
DNA/RNA sequence underneath.

The long term goal here is to take a human genome (say 1 gb of data) or a large protein/Sequence and break it down into
multiple smaller files that the "Agent" can access as it sees fit.
