...
public class ReversalDistance
{
    ...
    ///     Any reversal can reduce bp, therefore, by at most 2 as every non boundary comparison within the reversal is
    ///     preserved
    ...
    /// </remarks>
    /// <see>
    ///     Park, Euna, "Exact and Approximation Algorithms for Computing Reversal Distances in Genome Rearrangement" (2008).
    ///     Master's Projects. 104.
    ...
    {
        var traversed = new HashSet<int[]>(IntArrayComparer.Shared);
        ...
        while (!traversed.Contains(_b))
        {
            ...
            {
                var currentBp =
                    SyntenyHelper.MinimumalBreakPointReversals(candidate.Values, out var nextGenCandidates, _b);
                ...
                foreach (var nextGen in nextGenCandidates)
                {
                    ...
                    if (IntArrayComparer.Shared.Equals(_b, nextGen.Item1)) reversals = nextRevTracker.Reversals;
