...
public class RnaSequenceTest
{
    ...
    public void WobbleDistanceLessThanSafe()
    {
        ...
        Assert.AreEqual(1, seq.NonCrossingsWithWobble());
    }
    ...
    public void WobbleBaseCase()
    {
        ...
        Assert.AreEqual(2, seq.NonCrossingsWithWobble());
    }
    ...
    public void WobbleBaseCase3()
    {
        ...
        Assert.AreEqual(3, seq.NonCrossingsWithWobble());
    }
    ...
    public void WobbleBaseCase4()
    {
        ...
        Assert.AreEqual(4, seq.NonCrossingsWithWobble());
    }
    ...
    public void WobbleGiven()
    {
        ...
        Assert.AreEqual(284850219977421, seq.NonCrossingsWithWobble());
    }
}