...
///     So a RegexMotif object, at construction, takes in the protein match string, converts it to the underlying
///     base regex and can determine if a given input string is an exact match.
///     <remarks>
///         Right now, this implementation is case-sensitive.
///     </remarks>
/// </summary>
public class RegexMotif: Motif
{
    public RegexMotif(string motif, int expectedLength = 0, string name = "") :base(motif, expectedLength, name)
    {
    ...
    public override bool IsMatchStrict(string input)
    {
