...
/// So a RegexMatch object, at construction, takes in the protein match string, converts it to the underlying
/// base regex and can determine if a given input string is an exact match.
/// <remarks>
/// Right now, this implementation is case-sensitive.
/// </remarks>
/// </summary>
public class RegexMatch : IMotif, IRegexMatch
{
    public RegexMatch(string motif, int expectedLength = 0, string name = "")
    {
        Name = name;
        InputMotif = motif;
